    ...
    <main className='signup-page'>
      ...
      { 
        ...
        <form className="form" onSubmit={(e) => {
          ...
          <img src="/mirrorstatlogo3.png" alt="" className="signup-logo" onClick={() => {
            navigate('/')
          }} />
          <span class="subtitle">Get started with Mirrorstat, just create an account and enjoy the best copytrading experience.</span>
